...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.justify-content-center.mb-5
      ...
      .col-md-6.col-lg-6(data-aos="fade-left") 
        img.mt-3(src='@/assets/curso/temas/tema1/img-1.png')
    ...
    .container.bg-white.py-2.fondo-1
      .row.align-items-center.justify-content-center.mb-5
        .col-12
          p.mb-4(data-aos="fade-right") La magnitud de la empresa estaba dada por el número de colaboradores en actividad, pero, a partir del mes de junio, el Gobierno Nacional, mediante Decreto 957 de 2019, definió el criterio único de clasificación del tamaño de las empresas de acuerdo con sus ingresos por actividades ordinarias, el cual entró en vigencia en diciembre del mismo año, así:
        .col-lg-10.col-12
          .titulo-sexto.color-acento-contenido(data-aos="zoom-in-right")
            p.titulo.pb-0.mb-0 <b>Tabla 1. </b> <i>Clasificación del tamaño empresarial según el criterio único de ingresos por actividades ordinarias</i>
    ...
    TabsC.color-acento-botones.mb-5(data-aos="zoom-in-down")
      .py-3.py-md-4(titulo="Primario")
        .row.justify-content-center.align-items-center.px-4
          .col-12.col-md-4.mb-3.mb-md-0
            img.mt-3(src="@/assets/curso/temas/tema1/img_4.png").m-auto
      ...
      .py-3.py-md-4(titulo="Secundario")
        .row.justify-content-center.align-items-center.px-4
          .col-12.col-md-4.mb-3.mb-md-0
            img.mt-3(src="@/assets/curso/temas/tema1/img_3.png").m-auto
          .col-12.col-md-6.mb-3.mb-md-0
            h4 Secundario
      ...
      .py-3.py-md-4(titulo="Terciario")
        .row.justify-content-center.align-items-center.px-4
          .col-12.col-md-4.mb-3.mb-md-0
            img.mt-3(src="@/assets/curso/temas/tema1/img_5.png").m-auto
          .col-12.col-md-6.mb-3.mb-md-0
            h4 Terciario
      ...
      .py-3.py-md-4(titulo="Cuaternario")
        .row.justify-content-center.align-items-center.px-4
            .col-12.col-md-4.mb-3.mb-md-0
              img.mt-3(src="@/assets/curso/temas/tema1/img_6.png").m-auto
            .col-12.col-md-6.mb-3.mb-md-0
              h4 Cuaternario
    ...
    .row.justify-content-evenly.align-items-center.mb-3
      ...
      .col-lg-6(data-aos="fade-right").mb-5
        img(src='@/assets/curso/temas/tema1/img_10.png')
    ...
    .row.align-items-center.justify-content-center
      .col-lg-10.col-12(data-aos="zoom-in-down")
        .tarjeta.color-secundario.p-3.mb-5
          .row.justify-content-around.align-items-center
            .col-3.col-sm-2.col-lg-1
              img(src="@/assets/curso/temas/ico_2.svg")
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h3.mb-1 Tipos de sociedades en Colombia
                  p.text-small Amplía el conocimiento sobre los tipos de sociedades en Colombia.  
                .col-sm-auto
        ...
        .tarjeta.color-secundario.p-3.mb-5
          .row.justify-content-around.align-items-center
            .col-3.col-sm-2.col-lg-1
              img(src="@/assets/curso/temas/ico_3.svg")
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h3.mb-1 Consolidado de sociedades en Colombia
                  p.text-small El siguiente cuadro comparativo permite analizar cada una de las sociedades de acuerdo con sus características. Recurso que también puede ser consultado en el material de apoyo.  
                .col-sm-auto
                  a.boton.color-acento-botones(:href="obtenerLink('/downloads/ConsolidadodesociedadesenColombia.pdf')" target="_blank")
                    span Descargar
    ...
    TabsB.color-acento-botones.mb-5
      ...
      .py-4.py-md-5.bg-rosa.p-4(titulo="Recursos humanos" :icono="require('@/assets/curso/temas/tema1/icon_4.svg')")
        .row
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/temas/tema1/img_tab_2.png', alt='')
      .py-4.py-md-5.bg-rosa.p-4(titulo="Producción" :icono="require('@/assets/curso/temas/tema1/icon_3.svg')")
        .row
          .col-md-8.mb-4.mb-md-0
            h4 Producción
        ...
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")(data-aos="zoom-in-down")
          .row.justify-content-center.align-items-center(titulo="Innovación")
            ...
            .col-6.col-lg-2.mb-4.mb-lg-0
              img(src='@/assets/curso/temas/tema1/ico_new_2.svg' alt='', style="width:120px; display:block; margin:auto 0;")
          .row.justify-content-center.align-items-center(titulo="Tecnología")
            ...
            .col-6.col-lg-2.mb-4.mb-lg-0
              img(src='@/assets/curso/temas/tema1/ico_new_3.svg'  alt='', style="width:120px; display:block; margin:auto 0;")
          .row.justify-content-center.align-items-center(titulo="Servicio al cliente")
            ...
            .col-6.col-lg-2.mb-4.mb-lg-0
              img(src='@/assets/curso/temas/tema1/ico_new_4.svg'  alt='', style="width:120px; display:block; margin:auto 0;")
      .col-lg-5(data-aos="fade-right")
        img(src='@/assets/curso/temas/tema1/img_11.png' alt='', style="width:500px; display:block; margin:auto 0;")
    ...
    .container.bg-white.py-2.fondo-1
      .row.align-items-center.justify-content-center.mb-5
        .col-12
          p.mb-4(data-aos="zoom-in-down") Algunas causas que dan origen al diagnóstico organizacional, de acuerdo con Celaya (2010), son:
          .titulo-sexto.color-acento-contenido
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-md-5(data-aos="fade-left") 
        img.mt-3(src='@/assets/curso/temas/tema1/img.png').mb-3
